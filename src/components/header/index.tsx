...
export default function Header() {
  ...
  return (
    <header className="flex h-12 flex-row  items-center justify-between bg-opacity-50 bg-gradient-to-br from-primary-700 to-blue-500 p-2 text-gray-100 md:p-4">
